...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview ">
                <a href="#"><i class="fa fa-link"></i> <span>UrunIslemleri</span>
                    <span class="pull-left-container">
                <i class="fa fa-angle-right pull-left"></i>
              </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{url('/slider')}}"> Urunler</a></li>
                    <li><a href="{{url('/createSlider')}}">Urun olustur </a></li>
                    <li><a href="{{url('/reportSlider')}}">rapor olustur </a></li>
                </ul>
